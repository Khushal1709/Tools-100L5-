...
export default function Signup() {
  return (
    <div className="flex min-h-screen w-full bg-purple-100">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-100 to-purple-200 z-0"></div>
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center p-4 md:p-0 relative z-10">
        {/* Left side with illustration */}
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 relative">
          {/* Welcome text watermark */}
          <div className="absolute top-[-50px] left-32 text-purple-300 font-bold text-8xl opacity-50 select-none">
            WELCOME
          </div>
        ...
        <div className="w-full md:w-1/2 max-w-md">
          ...
          <div className="absolute bottom-0  top-140 left-270 w-[480px] h-50 pointer-events-none">
        <img
          ...
          width={300}
          height={300}
          className="w-full h-full object-contain opacity-500"
        />
      </div>
            {/* Logo */}
            <div className="flex justify-end mb-6">
              <img src={logo} alt="Logo" className="h-10 w-auto m-auto" />
            </div>
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-70 ml-12 bg-navy-900 text-white rounded-full py-3 font-medium hover:bg-navy-800 transition duration-300 cursor-pointer"
