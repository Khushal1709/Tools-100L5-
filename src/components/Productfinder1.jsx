          ...
          >
            ...
            <div class="max-w-7xl mx-auto">
              ...
              <div class="flex justify-between items-center bg-[#e3effc] rounded-full px-6 py-3">
                ...
                <a href="#" class="text-[#23233c] font-medium hover:underline">
                  Boost
                </a>
              </div>
              {/* <!-- Card --> */}
              <div class="bg-white rounded-3xl shadow p-6 md:p-10">
                ...
                <div class="text-[#888888] text-base leading-relaxed space-y-4 mb-6">
                  <p>
                    Discover a growing, hand-curated collection of 2100+ highly
                    useful tools and resources all in one place. Webcurate is a
                    hand-curated directory that showcases daily a hand-curated
                    selection of highly useful tools and resources for various
                    use cases, including business, marketing, website
                    development, content creation, productivity, design, and
                    job-related needs.
                  </p>
                  <p>
                    The platform currently features over 2100 tools and products
                    in over 200 categories and serves as a comprehensive
                    resource for users seeking high-quality, useful products and
                    tools.
                  </p>
                  <p>
