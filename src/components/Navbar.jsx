...
//   const isProductFinderPage = location.pathname === "/Productfinder";
...
//               {/* Get Featured Dropdown - Mobile */}
//               <div className="relative z-10">
//                 <button
//                   className="flex items-center text-gray-700 hover:text-gray-900 w-full justify-between"
//                   onClick={toggleMobileFeatured}
//                 >
//                   {isProductFinderPage ? "Get Featured" : "Categories"}
//                   <ChevronDown
//                     className={`ml-1 h-4 w-4 transition-transform ${
//                       mobileFeaturedOpen ? "rotate-180" : ""
//                     }`}
...
//           {/* Categories/Get Featured Dropdown - Desktop */}
//           <div
//             className="relative"
//             onMouseEnter={() => setFeaturedOpen(true)}
//             onMouseLeave={() => setFeaturedOpen(false)}
...
//   const [productFinderClicked, setProductFinderClicked] = useState(false);
...
//   // Handle Product Finder click (desktop & mobile)
//   const handleProductFinderClick = (e) => {
//     e.preventDefault();
//     setProductFinderClicked(true);
...
//               <button
//                 className="text-gray-700 hover:text-gray-900 flex items-center"
//                 onClick={handleProductFinderClick}
//                 style={{ background: "none", border: "none" }}
//               >
//                 {productFinderClicked ? "Submit" : "Product Finder"}
//               </button>
