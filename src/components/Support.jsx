...
import { Link } from 'react-router-dom';
 ...
 <div className="flex flex-col lg:flex-row items-center justify-between gap-6 relative z-10">
     ...
     <div className="space-y-2">
         ...
         <div className="relative inline-block">
             <Link to="/Contact"><button className="mt-2 bg-[#070742] text-white font-semibold px-8 py-3 rounded-full text-sm uppercase shadow-md cursor-pointer" onClick={scrollToTop}>
                 Contact Us
             </button>
             </Link>
             <div className="absolute -top-1 -right-2 p-2">
     ...
     <div className="bg-white shadow-lg rounded-full px-4 py-2 flex items-center w-full max-w-md">
         <input
             ...
             className="flex-grow outline-none bg-transparent px-2 text-sm text-gray-700"
         />
         <Link to="/Contact"><button className="bg-[#14143B] text-white px-5 py-2 rounded-full font-semibold text-sm cursor-pointer" onClick={scrollToTop}>
             Sign up
         </button> </Link>
     </div>
 </div>
